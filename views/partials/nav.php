<nav class="bg-gray-800">
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="#" class="<?= $_SERVER["REQUEST_URI"] === "/" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> block rounded-md px-3 py-2 text-base font-medium">Dashboard</a>
            <a href="#" class="<?= $_SERVER["REQUEST_URI"] === "/" ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> block rounded-md px-3 py-2 text-base font-medium">Team</a>
            <a href="#" class=" block rounded-md px-3 py-2 text-base font-medium">Projects</a>
            <a href="#" class=" block rounded-md px-3 py-2 text-base font-medium">Calendar</a>
            <a href="#" class=" block rounded-md px-3 py-2 text-base font-medium">Reports</a>
        </div>
